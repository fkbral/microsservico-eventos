...
import { CreateEvent } from "../useCases/CreateEventUseCase";
...
export const createEventHandlerWithInjection = async (
  ...
  const createEventUseCase = container.resolve(CreateEvent);
  const newEvent = await createEventUseCase.execute(event);
  return newEvent;
};
...
export class EventController {
  ...
  // }
  // Essa é a forma sucinta de escrever o código das quatro linhas acima
  constructor(
    @inject("UsersService")
